...
import { resolveButtonState, resolveOutgoingCancel, resolveUnfollow, } from "./follow-state.js";
/**
 ...
 */
const notFound = () => ({ success: false, message: "Follow relationship not found." });
...
const labelOf = (server) => resolveButtonState(server.flags());
