...
import { PostApiFollowAcceptFollowRequestBody, PostApiFollowFollowBody, PostApiFollowRejectFollowRequestBody, PostApiFollowUnfollowBody, } from "./follow.js";
/**
...
describe("FollowRequest body schemas", () => {
    ...
    it("strip unknown keys so stale aliases never reach the wire", () => {
        ...
        for (const schema of Object.values(bodies)) {
            assert.deepEqual(schema.parse({ followerId: "u-1", targetUserId: "u-2", followingId: "u-2" }), { followerId: "u-1", targetUserId: "u-2" });
        }
    });
