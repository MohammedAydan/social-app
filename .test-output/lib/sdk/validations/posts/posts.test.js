...
import { GetApiPostsFeedQueryParams, GetApiPostsMyPostsQueryParams, GetApiPostsUserUserIdQueryParams, PostApiPostsBody, PostApiPostsShareBody, PutApiPostsBody, } from "./posts.js";
/**
...
describe("PostApiPostsBody (create)", () => {
    it("accepts the canonical shape", () => {
        assert.deepEqual(PostApiPostsBody.parse({
            title: "Hi",
            content: "Hello",
            visibility: "Public",
...
describe("PostApiPostsShareBody", () => {
    it("requires parentPostId", () => {
        ...
        assert.deepEqual(PostApiPostsShareBody.parse({ parentPostId: "p-9", visibility: "Public" }), { parentPostId: "p-9", visibility: "Public" });
    });
});
