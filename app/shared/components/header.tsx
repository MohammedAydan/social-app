...
const Header = () => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 w-full h-16 px-8 flex justify-between items-center border-b z-30 bg-background/5 backdrop-blur-xl shadow-sm">
